...
export default function HomeLogo({fontSize="2xl", iconSize=20}:{fontSize?: string, iconSize?: number}) {
  return (
    <Link href={"/"} className={cn("text-2xl font-extrabold flex items-center gap-2", fontSize)}>
        ...
        <div>
            <span className='bg-gradient-to-r from-emerald-500 to-blue-500 bg-clip-text text-transparent'>D</span>
            <span className='text-stone-700 dark:text-stone-300'>K</span>
        </div>
    </Link>
  )
};