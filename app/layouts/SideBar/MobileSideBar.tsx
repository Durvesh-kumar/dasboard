          ...
          <div className="flex flex-col flex-1 gap-10 px-5 mt-10">
            ...
            <div>
              ...
              <div className="w-full flex items-center justify-between rounded-2xl p-2 mt-1 border-2 border-primary h-12">
                ...
                {isOpenDate && (
                  <div className="absolute top-20 left-0 bg-background p-2 z-50 overflow-x-auto bg-white max-md:w-[400px] rounded-lg border-primary border-separate border-2">
                    <DateRangePicker
                    ...
                    <span className="flex items-center gap-4 justify-end">
                      <Button
                        ...
                        onClick={() =>
                          setFilterData(
                            allData?.filter((item) => item.poc.length > 1)
                          )
                        }
                      >
                        All
                      </Button>
                      <Button onClick={() => setIsOpenDate(false)}>
                        close
                      </Button>
                    </span>
                  </div>
